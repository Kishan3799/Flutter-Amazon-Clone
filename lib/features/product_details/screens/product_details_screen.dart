...
import 'package:amazon_clone/features/accounts/widgets/stars.dart';
...
class _ProductDetailedScreenState extends State<ProductDetailedScreen> {
  final ProductDetailsServicse productDetailsServicse =
      ProductDetailsServicse();
  double avgRating = 0;
  double myRating = 0;
  ...
  void addToCart(){
    productDetailsServicse.addToCart(context: context, product: widget.product);
  }
            ...
            children: [
              ...
              RatingBar.builder(
                  ...
                  onRatingUpdate: (rating) {
                    productDetailsServicse.rateProduct(
                        context: context,
